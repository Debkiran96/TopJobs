...
employee.setEmailId(userid);
EmployeeDaoImpl employeeDaoImpl = new EmployeeDaoImpl();
ArrayList<Jobs> joblist = employeeDaoImpl.Viewjob(employee);
for( Jobs job:joblist){
	int jobid= job.getJobid();
	String job_status=job.getJob_status();
	String className="";
	if(job_status.equals("No"))
		className="Job";
	else
		className="NoJob";
%>
...
<button type="submit" class="btn btn-primary">View Applicant</button>
</form>
</div> 
